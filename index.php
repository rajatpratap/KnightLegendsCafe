...
<head>
	...
	<!-- Site Metas -->
	<title>Knight Legends Cafe</title>
		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Knight Legends Cafe</strong></h1>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Knight Legends Cafe</span></h1>
						<h4>Little Story</h4>
	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<h3>About Us</h3>
					<p>We are the Knight Legeds Cafe. We are not the just a cafe or an organization to deliver a piece
						of product but we assure that our customers to attain an experience of excellence with
						all our best practices & services.</p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Subscribe</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name">All Rights Reserved. &copy; 2020 <a href="#">Knight Legends Cafe</a>
							Design By :
							<a href="https://html.design/">Mr. James</a></p>
					</div>
				</div>
			</div>
		</div>
